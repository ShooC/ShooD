...
const sections = [
   {
	...
	rows: [
	    ...
	    {title: "PICKAXE ⛏️", rowId: ".craft pickaxe", description: "Buqt Pickaxe"},
	    {title: "FISHINGROD 🎣", rowId: ".craft fishingrod", description: "Membuat Pancing"},
	    {title: "ARMOR 🥼", rowId: ".craft armor", description: "Membuat Armor"},
	    {title: "ATM 💳", rowId: ".craft atm", description: "Membuat Atm (but that's ilegal)"},
	]
    },
]
