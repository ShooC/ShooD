 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
   ...
   const sections = [
   {
	...
	rows: [
	    {title: `🕰️ ${pmenus} 𝚂𝙿𝙴𝙴𝙳 𝙱𝙾𝚃`, rowId: ".ping", description: "𝙼𝚎𝚗𝚊𝚖𝚙𝚒𝚕𝚔𝚊𝚗 𝙺𝚎𝚌𝚎𝚙𝚊𝚝𝚊𝚗 𝚁𝚎𝚜𝚙𝚘𝚗 𝙱𝙾𝚃"},
	...
	rows: [
	    {title: `💹 ${pmenus} 𝙳𝙾𝙽𝙰𝚃𝙴`, rowId: ".donasi", description: 'Support Bot Agar Bisa Online 24 Jam'},
	]
	},{
	title: `${htki} ᴍᴇɴᴜ ${htka}`,
	rows: [
	    {title: `📚 ${pmenus} All`, rowId: ".? all", description: "Menampilkan Semua command BOT"},
	    {title: `🌱 ${pmenus} Rpg`, rowId: ".? rpg", description: "Epic Rpg"},
	...
	{title: `⛩️ ${pmenus} Anime`, rowId: ".? anime", description: "Wibuuuu"},
	...
	{title: `✏️ ${pmenus} Nulis`, rowId: ".? nulis", description: "Nulis kak"},
	...
	{title: `❓ ${pmenus} No Category`, rowId: ".? nocategory", description: "Tanpa Kategori"},
	]
  },
]
