  ...
  if (m.chat.endsWith('status@broadcast')) {
    ...
    if (m.isGroup) {
      if (m.mentionedJid.includes(this.user.jid)) {
        await this.sendButton(m.chat, isBanned ? "Grup Ini Diban Oleh owner" : banned ? "Anda telah dibanned" : "🪐 Bot Status: Online", author, null, [[isBanned ? 'Unbanned' : banned ? 'Creator' : 'Menu',
